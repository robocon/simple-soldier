<style type="text/css">
    ...
    table{width: 100%;border-spacing: 0;height: 100%;}
    td{padding: 1px 4px;}
    .t-contain{border: 1px solid #000000;}
    .tbr{border-right: 1px solid #000000;}
    .tbb{border-bottom: 1px solid #000000;}
    .tbl{border-left: 1px solid #000000;}
    .tbt{border-top: 1px solid #000000;}
