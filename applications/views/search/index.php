                        ...
                        foreach ($patient_list as $key => $patient) {
                            ...
                            <tr>
								...
								<td>
                                    ...
                                    if(@$hospital_list[$hos_id])
                                    {
                                        echo $hospital_list[$hos_id];
                                    }
									?>
								</td>
                                <td><a href="<?=getUrl();?>printpt/base/<?=$patient['id'];?>/<?=$tkPrintpt;?>" target="_blank" title="พิมพ์"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
